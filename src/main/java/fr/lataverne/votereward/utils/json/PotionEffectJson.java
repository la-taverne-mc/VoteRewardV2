...
enum PotionEffectJson {
    ...
    public static @Nullable PotionEffect deserialize(final @NotNull JsonElement elemPotionEffect) {
        if (elemPotionEffect.isJsonObject()) {
            ...
            if (jsonPotionEffect.has("type") && jsonPotionEffect.has("amplifier") && jsonPotionEffect.has("duration") && jsonPotionEffect.has("ambient") && jsonPotionEffect.has("icon") && jsonPotionEffect.has("particles")) {
