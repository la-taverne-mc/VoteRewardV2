...
public enum Helper {
	...
	public static String replaceValueInString(final String str, final String... args) {
		@NonNls String output = str;
	...
	public static void sendMessageToPlayer(final Player player, final String message) {
